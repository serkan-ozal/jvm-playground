...
public class OnTheFlyDebuggingManagement {
    ...
    private static Map<String, Map<String, Object>> listenerMap = 
    ...
    public static void main(String[] args) throws Exception {
        final String debugId = startDebugging(); // Start debugging with default parameters
    ...
    private static void init() throws Exception {
        vmm = com.sun.tools.jdi.VirtualMachineManagerImpl.virtualMachineManager();
        
        System.out.println("================================================");
        System.out.println("ALL       CONNECTORS >>> " + vmm.allConnectors());
        System.out.println("LISTENING CONNECTORS >>> " + vmm.listeningConnectors());
        System.out.println("ATTACHING CONNECTORS >>> " + vmm.attachingConnectors());
        System.out.println("================================================\n");

        stringArgumentImplClass = Class.forName("com.sun.tools.jdi.ConnectorImpl$StringArgumentImpl");
        integerArgumentImplClass = Class.forName("com.sun.tools.jdi.ConnectorImpl$IntegerArgumentImpl");

        // String name, String label, String description, String value, boolean mustSpecify
        stringArgumentImplClassCons = 
                stringArgumentImplClass.
        ...
        // String name, String label, String description, String value, boolean mustSpecify, int min, int max
        integerArgumentImplClassCons = 
                integerArgumentImplClass.
                    getDeclaredConstructor(
                        Class.forName("com.sun.tools.jdi.ConnectorImpl"),
                        String.class, 
                        String.class, 
    ...
    public static String startDebugging(int listeningPort, 
        ...
        for (ListeningConnector lc : vmm.listeningConnectors()) {
            if (lc instanceof SocketListeningConnector) {
                ...
                arguments.put(
                        ...
                        stringArgumentImplClassCons.
                            newInstance(
                                slc, 
                                "port", 
                                "socket_listening.port.label",
                                "socket_listening.port", 
                ...
                System.out.println("Started listening for debugging with debug id " + debugId); 
    ...
    public static void stopDebugging(String debugId) throws Exception {
        ...
        if (arguments == null) {
            throw new IllegalArgumentException("Couldn't be found debugger for debug id " + debugId);
        }
        for (ListeningConnector lc : vmm.listeningConnectors()) {
            if (lc instanceof SocketListeningConnector) {
                SocketListeningConnector slc = (SocketListeningConnector) lc;
                ...
                System.out.println("Stopped listening for debugging with debug id " + debugId);
