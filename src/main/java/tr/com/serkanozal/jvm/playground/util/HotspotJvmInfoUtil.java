...
public class HotspotJvmInfoUtil {
    ...
    private static final Logger logger = Logger
            .getLogger(HotspotJvmInfoUtil.class);
    ...
    public static void main(final String[] args) throws InterruptedException {
        try {
            ...
            if (vmInitialized) {
                try {
                    System.out.println(JVM_INFO_LINE + " "
                            + NARROW_OOP_BASE_INFO_KEY + " "
                            + Universe.getNarrowOopBase());
                    System.out.println(JVM_INFO_LINE + " "
                            + NARROW_OOP_SHIFT_INFO_KEY + " "
    ...
    private static HotspotJvmInfo findJvmInfo(int processId) {
        ...
        try {
            ...
            args.add(System.getProperty("java.home") + "/" + "bin" + "/"
                    + "java");
            args.add("-cp");
            ...
            BufferedReader brErr = new BufferedReader(new InputStreamReader(
                    p.getErrorStream()));
            for (String line = brErr.readLine(); line != null; line = brErr
                    .readLine()) {
